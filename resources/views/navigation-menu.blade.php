<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0 z-30">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('sponsorships.index') }}" :active="request()->routeIs('sponsorships.index')">
                        {{ __('Sponsorships') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('partnerships.index')">
                {{ __('Partnerships') }}
            </x-responsive-nav-link>

            <x-responsive-nav-link href="{{ route('sponsorships.index') }}" :active="request()->routeIs('sponsorships.index')">
                {{ __('Sponsorships') }}
            </x-responsive-nav-link>
        </div>
